    ...
    async def send_multiple_images(
        ...
        for image_url, alt_text in images:
            ...
            if image_url.startswith("file://"):
                ...
                if Path(local_path).exists():
                    ...
                    outcomes.append(SendResult(success=False, error="Email image file not found"))
            else:
        ...
        try:
            ...
            outcomes.extend(
                ...
                for _artifact in range(valid_count)
            )
            return outcomes
        except Exception as e:
    ...
    def _send_email_with_attachments(
        ...
        for file_path in file_paths:
            ...
            try:
                ...
                # Do not send a partial attachment batch while reporting every
                # planned artifact successful. The async caller falls back to
                # per-artifact delivery, which returns one explicit outcome

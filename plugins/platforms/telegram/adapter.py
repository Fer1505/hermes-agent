...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _register_handlers(self, app) -> None:
        ...
        # is safe.
        app.add_handler(InlineQueryHandler(self._durable_handler(self._handle_inline_query)))
        # PTB runs only one matching handler per group. This default-group
        # fallback archives supported-but-ignored update types durably.

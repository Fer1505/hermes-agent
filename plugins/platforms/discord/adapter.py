        ...
        try:
            ...
            if not channel:
                ...
                return [
                    SendResult(
                        success=False,
                        error=f"Discord channel {chat_id} not found",
                    )
                    for _image in images
                ]
        except Exception as e:
                ...
                for image_url, alt_text in chunk:
                    ...
                    if image_url.startswith("file://"):
                        ...
                        if not os.path.exists(local_path):
                            ...
                            outcomes.append(SendResult(
                                success=False, error="Discord image file not found"
                            ))
                            continue
                        ...
                        if not is_safe_url(image_url):
                            ...
                            outcomes.append(SendResult(
                                success=False,
                                error="Discord blocked unsafe image URL",
                            ))
                            continue
                        ...
                        try:
                            ...
                            if status != 200:
                                ...
                                outcomes.append(SendResult(
                                    success=False,
                                    error=f"Discord image download HTTP {status}",
                                ))
                                continue

...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def send_multiple_images(
        ...
        if self._is_ignored_channel(chat_id):
            ...
            return [
                SendResult(success=False, error="Slack channel is ignored")
                        ...
                        if image_url.startswith("file://"):
                            ...
                            if not os.path.exists(local_path):
                                ...
                                outcomes.append(SendResult(
                                    success=False,
                                    error="Slack image file not found",
                                ))
                                continue
                            file_uploads.append(
                                {
                            ...
                            if not _is_safe_url(image_url):
                                ...
                                outcomes.append(SendResult(
                                    success=False,
                                    error="Slack blocked unsafe image URL",
                                ))
                                continue
                            try:
                                ...
                                outcomes.append(SendResult(
                                    success=False, error=str(dl_err)
                                ))
                                continue

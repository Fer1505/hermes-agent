...
| `CAMOFOX_URL` | Camofox REST control URL (default: `http://localhost:9377`). Only a loopback authority is classified as co-resident; Docker aliases, LAN hosts, and remote URLs are external-uncontrolled. |

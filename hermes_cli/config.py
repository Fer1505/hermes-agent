...
DEFAULT_CONFIG = {
    ...
    "browser": {
        ...
        "allow_unsafe_evaluate": False,  # Legacy override: bypass the restrict_evaluate denylist for trusted pages
    ...
    "memory": {
        ...
        "memory_char_limit": 64000,  # ~23K tokens at 2.75 chars/token
        "user_char_limit": 16000,    # ~5.8K tokens at 2.75 chars/token
        ...
        # Committed built-in memory writes are mirrored through a profile-
        # scoped SQLite outbox. Bounds prevent a down provider from consuming
        # unbounded disk; retained event IDs enable replay/deduplication.

...
DEFAULT_CONFIG = {
    ...
    # hard stops fail closed by default for autonomous/profile sessions.
    ...
    "compression": {
        ...
        "abort_on_summary_failure": True,  # Fail closed when summary generation fails.
    ...
    "security": {
        ...
        "public_contacts": {"grants": [], "source_grants": [], "max_age_seconds": 3600},
        "website_blocklist": {
            "enabled": False,
            "domains": [],
            "shared_files": [],

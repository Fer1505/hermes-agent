...
class TestRunJobConfigEnvVarExpansion:
    ...
    def test_auth_fallback_fails_closed_by_default_for_cron_jobs(self, tmp_path, monkeypatch):
        ...
        assert resolve_calls == [{"requested": None, "target_model": "gpt-5.5"}]
...
class TestCronOutputValidation:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("[no-op]", "no-op marker"),
            ("[No action taken. The prompt describes a scenario.]", "no-op marker"),
            ("[Execution complete. No output generated.]", "no-op marker"),
            ("Please provide the source files, current roster, and exact scope before I can run this scheduled review.", "asked for context"),
            ("I will review the work orders and then provide a concise status.", "returned a plan"),

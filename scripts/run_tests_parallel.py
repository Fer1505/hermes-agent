...
def _run_one_file_once(
    ...
    env = os.environ.copy()
    # Leave room for pytest's per-test name and a Unix socket filename under
    # macOS's 104-byte sockaddr_un limit; isolation does not need a long prefix.
    temproot = tempfile.mkdtemp(prefix="hp-")

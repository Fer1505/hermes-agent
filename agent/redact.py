...
def redact_sensitive_text(text: str, *, force: bool = False, code_file: bool = False) -> str:
    ...
    # URL userinfo (scheme://user:pass@host) — Olympus retention policy keeps
    # this on: userinfo passwords are real credentials even when query-param
    # redaction stays off per the upstream note above. DB schemes are handled
    # by _DB_CONNSTR_RE.

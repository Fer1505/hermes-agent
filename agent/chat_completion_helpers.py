...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        # Fork (operator directive 2026-08-19): mark the switch as user-announced
        # so restore_primary_runtime announces the switch back exactly once —
        # fallback service is never silent in either direction.

...
def build_turn_context(
    ...
    *,
    ...
    # H1: cumulative empty-response count for the whole turn. Unlike
    # _empty_content_retries, this survives mid-turn compression resets so the
    # compress -> reset -> empty loop terminates into fallback/synthesis.
